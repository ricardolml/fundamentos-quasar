<template>
    <q-page class="flex column q-pa-md">
        ...
        <span class="text-subtitle1">Subtitle</span>
        <span class="text-subtitle2">Subtitle</span>

        <q-separator />

        <p class="text-body1">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt
            qui dolorum corporis dolorem, rem at rerum ducimus fugiat iure
            incidunt tempore laboriosam quas ullam eveniet quibusdam impedit
            suscipit labore commodi?
        </p>
        <p class="text-body2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt
            qui dolorum corporis dolorem, rem at rerum ducimus fugiat iure
